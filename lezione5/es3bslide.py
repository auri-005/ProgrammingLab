...
materie_studente=["Analisi I","Sistemi Operativi","Programmazione","Algebra Lineare","Analisi dei Dati"]

materie_docente=["Analisi II","Sistemi Operativi","Laboratorio 1","Algebra Lineare","Analisi dei Dati","Calcolo delle probabilita"]
 
Prof=Docente('Fabrizio','Ferrari',materie_docente)

Students=Studente('Vincenzo','Riccotti',materie_studente)
